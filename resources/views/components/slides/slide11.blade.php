<div class="slide bg-white rounded-xl shadow-xl p-8">
    <h2 class="text-3xl font-bold mb-4 slide-title">Tabla resumen de hooks en React Native</h2>
    ...
    <p class="text-base text-gray-500">Consulta la <a href="https://docs.expo.dev/router/introduction/" class="text-indigo-600 underline" target="_blank">documentación oficial de Expo Router</a> y la <a href="https://reactnative.dev/docs/getting-started" class="text-indigo-600 underline" target="_blank">documentación de React Native</a> para más detalles y ejemplos.</p>
</div>
